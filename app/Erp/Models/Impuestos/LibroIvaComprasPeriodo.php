...
class LibroIvaComprasPeriodo extends Model
{
    protected $table = 'erp_libro_iva_compras_periodo';
    ...
    protected $fillable = [
        ...
        'percepciones_iva_sufridas', 'percepciones_iibb_sufridas',
        'retenciones_iva_sufridas', 'retenciones_gan_sufridas',
        'otros_tributos', 'total_facturado', 'cantidad_comprobantes',
